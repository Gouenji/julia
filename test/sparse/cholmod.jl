...
@testset "Check inputs to Sparse. Related to #20024" for A in (
    SparseMatrixCSC(2, 2, [1, 1], CHOLMOD.SuiteSparse_long[], Float64[]),
    SparseMatrixCSC(2, 2, [1, 1, 1], CHOLMOD.SuiteSparse_long[1], Float64[]),
    SparseMatrixCSC(2, 2, [1, 1, 1], CHOLMOD.SuiteSparse_long[], Float64[1.0]),
    SparseMatrixCSC(2, 2, [1, 1, 1], CHOLMOD.SuiteSparse_long[1], Float64[1.0]))
